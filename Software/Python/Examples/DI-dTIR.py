...
try:
    while True:
        ...
        #     The first item in the list is a list of the I2C bytes read from the sensor.
        #     The second item in the list is the error value (should be equal to BP.SUCCESS if the value was read successfully)
        value, error = BP.get_sensor(BP.PORT_1)
        if error == BP.SUCCESS:                        # if communication successful
