...
print("\nUSER INSTRUCTIONS:")
print("Connect the EV3 ultrasonic sensor to BrickPi3 sensor port 1.")
print("This program will continuously print the distance measured by the sensor in centimeters.")
...
try:
    while True:
        ...
        try:
            value = BP.get_sensor(BP.PORT_1)
            print(f"Distance: {value:3.0f} cm")      # print the distance in CM
