...
print("NXT Ultrasonic Sensor Example")
print("=============================")
print("This program reads distance values from an NXT ultrasonic sensor.")
print("Make sure an NXT ultrasonic sensor is connected to BrickPi3 Port 1.")
print()
print("Instructions:")
...
try:
    while True:
        ...
        try:
            ...
            print(f"Distance: {value:3.0f} cm")
