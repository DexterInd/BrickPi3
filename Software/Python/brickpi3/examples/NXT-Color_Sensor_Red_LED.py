...
print("NXT Color Sensor Red LED Example")
print("================================")
print("This program reads red light reflection values from an NXT color sensor.")
...
try:
    while True:
        ...
        try:
            ...
            print(f"Red Light Value: {value:03.0f}")
